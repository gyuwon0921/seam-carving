...
public:
  ...
  int** GetHorizontalSeam1(int** array) const;
  int* GetHorizontalSeam2(int* hor_arr, int** array) const;
  ...
  // returns {1, 2, 2}
  int* GetVerticalSeam();
  int** GetVerticalSeam1(int** array) const;
  int* GetVerticalSeam2(int* vert_arr, int** array) const;
  ...
  int Getred(int a, int row, int col);
  int Getblue(int a, int row, int col);
  int Getgreen(int a, int row, int col);
  int Ccr(int a, int row, int col);
  int Ccb(int a, int row, int col);
  int Ccg(int a, int row, int col);
  int Rr(int a, int row, int col);
  int Rb(int a, int row, int col);
  int Rg(int a, int row, int col);
  int Rrr(int a, int row, int col);
  int Rrb(int a, int row, int col);
  int Rrg(int a, int row, int col);
